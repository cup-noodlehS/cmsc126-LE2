...
const navigation = [
  ...
  { name: "Budget", href: "/budget", icon: BudgetIcon },
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="md:hidden fixed top-4 left-4 z-50 p-2 text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-900 rounded-md shadow-md"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-white dark:bg-gray-900 shadow-lg transition-transform duration-300 ease-in-out transform ${
        ...
        <div className="h-full flex flex-col">
          <div className="px-4 py-6 border-b border-gray-200 dark:border-gray-800">
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 mr-2 text-blue-600 dark:text-blue-400">
